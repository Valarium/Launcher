...
function updateSelectedServer(serv) {
    ...
    ConfigManager.save()
    server_selection_button.innerHTML = '\u2022 ' + (serv != null ? serv.getName() : 'Pas de serveur sélectionné')
    if (getCurrentView() === VIEWS.settings) {
    ...
    sysAEx.on('message', (m) => {
        ...
        if (m.context === 'validateJava') {
            if (m.result == null) {
                ...
                setOverlayContent(
                    'Pas de version Java installée',
                    "Pour rejoindre Valarium, vous avez besoin d'une installation 64 bits de Java 8. Voulez-vous que nous en installions une copie ? En l'installant, vous acceptez <a href=\"http://www.oracle.com/technetwork/java/javase/terms/license/index.html\">le contrat de licence d'Oracle</a>.",
                    'Installer Java',
                ...
                setDismissHandler(() => {
                    $('#overlayContent').fadeOut(250, () => {
                        ...
                        setOverlayContent(
                            'Java est requis<br>pour lancer Valarium',
            ...
            if (m.result === true) {
                ...
                setOverlayContent(
                    'Erreur inconnue<br>Le téléchargement de Java a échoué',
        ...
        if (m.context === 'validate') {
            switch (m.data) {
                ...
                case 'libraries':
                    ...
                    setLaunchDetails('Vérification de l\'intégrité des fichiers divers..')
                    break
                case 'files':
            ...
            if (m.result.forgeData == null || m.result.versionData == null) {
                ...
                showLaunchFailure('Erreur durant le lancement', 'Merci de contacter le staff si ce souci persiste')
            ...
            if (login && allGood) {
                ...
                const gameStateChange = function (data) {
                    ...
                    if (SERVER_JOINED_REGEX.test(data)) {
                        ...
                        DiscordWrapper.updateDetails('Sailing to Valarium!')
                    }
                }
                ...
                const gameErrorListener = function (data) {
                    ...
                    if (data.indexOf('Could not find or load main class net.minecraft.launchwrapper.Launch') > -1) {
                        ...
                        showLaunchFailure('Erreur durant le lancement', "Le fichier principal, LaunchWrapper, n'a pas réussi à se télécharger correctement. En conséquence, le jeu ne peut pas être lancé.<br><br>Pour résoudre ce problème, désactivez temporairement votre logiciel antivirus et lancez à nouveau le jeu.")
                    }
                }
                ...
                try {
                    ...
                    setLaunchDetails('Fini ! Profitez du serveur !')
                    ...
                    loggerLaunchSuite.error('Error during launch', err)
                    showLaunchFailure('Erreur durant le lancement', 'Merci de contacter le staff si le problème persiste')
    ...
    refreshDistributionIndex(true, (data) => {
        ...
        refreshDistributionIndex(false, (data) => {
            ...
            if (DistroManager.getDistribution() == null) {
                showLaunchFailure('Erreur fatale', "Impossible de charger une copie de l'index de distribution. Ce fichier est nécessaire au lancement du jeu.")
