        ...
        val.onclick = (e) => {
            ...
            if (Object.keys(ConfigManager.getAuthAccounts()).length === 1) {
                ...
                setOverlayContent(
                    ...
                    "Afin d'utiliser le launcher, vous devez être connecté à au moins un compte. Vous devrez vous reconnecter après.<br><br>Vous êtes sûr de vouloir vous déconnecter ?",
                    'Je suis sûr',
                    'Annuler'
                )
                setOverlayHandler(() => {
...
function refreshAuthAccountSelected(uuid) {
    Array.from(document.getElementsByClassName('settingsAuthAccount')).map((val) => {
        ...
        if (uuid === val.getAttribute('uuid')) {
            ...
            selBtn.innerHTML = 'Choisir un compte'
        }
    })
}
        ...
        authAccountStr += `<div class="settingsAuthAccount" uuid="${acc.uuid}">
            ...
            <div class="settingsAuthAccountRight">
                ...
                <div class="settingsAuthAccountActions">
                    <button class="settingsAuthAccountSelect" ${selectedUUID === acc.uuid ? 'selected>Compte sélectionné &#10004;' : '>Choisir un compte'}</button>
...
function populateReleaseNotes() {
    $.ajax({
        url: 'https://github.com/Valarium/Launcher/releases.atom',
        success: (data) => {
        ...
        settingsAboutChangelogText.innerHTML = 'Échec du chargement des notes de versions'
    })
}
...
function populateSettingsUpdateInformation(data) {
    if (data != null) {
        ...
        if (process.platform === 'darwin') {
            settingsUpdateButtonStatus('Télécharger depuis Github<span style="font-size: 10px;color: gray;text-shadow: none !important;">Fermez le lanceur et exécutez le fichier pour mettre à jour.</span>', false, () => {
